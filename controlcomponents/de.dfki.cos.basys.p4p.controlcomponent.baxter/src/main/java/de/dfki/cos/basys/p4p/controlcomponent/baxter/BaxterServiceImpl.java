...
public class BaxterServiceImpl implements BaxterService, ServiceProvider<BaxterService>, ActionCallback {
	...
	public BaxterServiceImpl(Properties config) {
		this.config = config;
		LOGGER =  LoggerFactory.getLogger("BaxterServiceImpl");
	}
	...
	@Override
	public BaxterService getService() {
		return this;
	}
