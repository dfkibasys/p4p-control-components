...
public class PEArrowsAndCircles extends ProjectionEntity {
	...
	public PEArrowsAndCircles() {
		this.type ="arrowsAndCircles";
	}
	
	public PEArrowsAndCircles(double x, double y, double z, int color, List<Point> points, int arrowCount, double innerCircleRadius, double middleCircleRadius, double outerCircleRadius, double angleStart, double angleLength, int delayArrows, int delayCircles) {
		this.type ="arrowsAndCircles";
		this.setX(x);
		this.setY(y);
		this.setZ(z);
