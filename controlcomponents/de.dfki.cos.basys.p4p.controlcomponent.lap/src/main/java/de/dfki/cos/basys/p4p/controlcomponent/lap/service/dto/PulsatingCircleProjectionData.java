...
public class PulsatingCircleProjectionData extends GeneralData {
	...
	public PulsatingCircleProjectionData() {
		this.type ="pulsatingCircle";
	}
	
	public PulsatingCircleProjectionData(double x, double y, double z, int color, double innerCircleRadius, double middleCircleRadius, double outerCircleRadius,  double angleStart, double angleLength, int delay) {
		this.type ="pulsatingCircle";
		this.setX(x);
		this.setY(y);
		this.setZ(z);
