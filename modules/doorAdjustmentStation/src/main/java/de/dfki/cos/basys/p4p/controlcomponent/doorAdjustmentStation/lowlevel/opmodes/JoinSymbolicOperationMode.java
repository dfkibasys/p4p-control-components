...
public class JoinSymbolicOperationMode extends BaseDoorAdjustmentStationOperationMode {
    ...
    public JoinSymbolicOperationMode(BaseControlComponent<DoorAdjustmentStationService> component) {
        super(component);
    }
    ...
    public void onStarting() {
        super.onStarting();
        executing = true;
        getService(DoorAdjustmentStationService.class).joinSymbolic(material_a, material_b, tool);
    }
