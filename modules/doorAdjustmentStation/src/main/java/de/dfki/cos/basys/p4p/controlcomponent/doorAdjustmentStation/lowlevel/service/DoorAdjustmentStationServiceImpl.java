...
import de.dfki.cos.basys.p4p.controlcomponent.doorAdjustmentStation.lowlevel.model.MaterialRemovedEvent;
...
public class DoorAdjustmentStationServiceImpl implements DoorAdjustmentStationService, ServiceProvider<DoorAdjustmentStationService> {
   ...
   @Bean
    ...
    private void handleAssemblyEventUpdates(AssemblyEvent assemblyEvent) {
        ...
        if (assemblyEvent.getConfidence() >= CONFIDENCE_THRESHOLD && !Objects.equals(assemblyEvent.getWorkstepId(), "workstep_error")){
