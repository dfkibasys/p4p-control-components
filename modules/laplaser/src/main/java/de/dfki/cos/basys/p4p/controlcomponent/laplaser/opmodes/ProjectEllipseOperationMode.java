...
public class ProjectEllipseOperationMode extends BaseLapOperationMode {
	...
	public ProjectEllipseOperationMode(BaseControlComponent<LapLaserService> component) {
		super(component);
	}
	...
	public void onStarting() {	
		super.onStarting();
		getService(LapLaserService.class).projectEllipse(x, y, z, color, majorRadius, minorRadius, angleStart, angleLength);
		executing = true;
	}
