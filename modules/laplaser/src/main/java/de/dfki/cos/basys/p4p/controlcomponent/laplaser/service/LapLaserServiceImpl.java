package de.dfki.cos.basys.p4p.controlcomponent.laplaser.service;
...
import de.dfki.cos.basys.p4p.controlcomponent.laplaser.service.dto.*;

public class LapLaserServiceImpl implements LapLaserService, ServiceProvider<LapLaserService> {
	private Properties config = null;

	protected final Logger LOGGER = LoggerFactory.getLogger(LapLaserServiceImpl.class.getName());
	private boolean connected = false;
	private String missionState = "pending";
	WebTarget resource = null;
	
	public LapLaserServiceImpl(Properties config) {
		this.config = config;
	}
	...
	@Override
	public LapLaserService getService() {
		return this;
	}
