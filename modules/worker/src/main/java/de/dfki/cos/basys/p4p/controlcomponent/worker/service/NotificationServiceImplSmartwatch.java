package de.dfki.cos.basys.p4p.controlcomponent.worker.service;
...
public class NotificationServiceImplSmartwatch implements NotificationService, ServiceProvider<NotificationService>{
	private static final Logger LOG = LoggerFactory.getLogger(NotificationServiceImplSmartwatch.class);
	...
	public NotificationServiceImplSmartwatch(Properties config) {
